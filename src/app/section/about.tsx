    ...
    <section id="about me" className="bg-navy-blue p-8">
      <div className="min-h-screen max-w-4xl mx-auto justify-center flex flex-col ">
        ...
        <p className="text-gray-100 mb-4 text-left ">
          Hi! I'm Andika, a Computer Science student and aspiring software
          developer, passionate about building useful and efficient web
          applications.
        </p>
        <p className="text-gray-100 text-left">
          In my spare time, I enjoy running, weightlifting, and exploring the
          latest in tech.
        </p>
        <div className="mt-8 flex items-start space-x-2">
          ...
          <a
            href="https://www.linkedin.com/in/andika-hernadi"
            target="_blank"
            rel="noopener noreferrer"
            className="cursor-pointer"
          >
          ...
          <a
            href="https://www.instagram.com/andikahernadi"
            target="_blank"
            rel="noopener noreferrer"
            className="cursor-pointer"
          >
